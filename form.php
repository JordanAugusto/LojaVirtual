            ...
            <div class="col-sn-4 col-sm-offset-4">
                <main class="login">
                    <div class="login_container">
                        ...
                        <form class="login_form" method="POST" action="validausuario.php" name="login"> <!--receber usuario-->
                            ...
                            <button class="login_submit" name="login" >Acessar</button>
                            <a class="login_reset" href="#"><h3>Esqueci a minha senha</h3></a><br>
                            <a class="login_reset" href="cadastro.php"><h3>Não sou cadastrado</h3></a>
